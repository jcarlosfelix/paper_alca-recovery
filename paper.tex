...
of candidate solutions based on either: The mutation with uniform modification
from the Elite or the historically best-found solution (Champion); Crossing the
Champion with the Elite; The projection of the Elite towards the Champion;
Based on random use of the previous alternatives.
...
\begin{table}[]
    ...
    \begin{tabular}{@{}ll@{}}
    \toprule
    \multicolumn{2}{l}{ALCA General Configuration} \\ \midrule
    Function name & ALL \\
    Population & 500 \\
...
\begin{table}[]
    ...
    \toprule
    \multicolumn{8}{l}{Benchmark Configuration Setup} \\ \midrule
