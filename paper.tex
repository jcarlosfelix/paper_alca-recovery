...
\section{Experiments}
    ...
    \subsection{Experiment Results}
        ...
        \subsubsection{Ackley Benchmark Function Experiment}
            ...
            Table~\ref{tab.fun_ackley5} and Table~\ref{tab.fun_ackley10} (for
        ...
        \subsubsection{Bohachevsky Benchmark Function Experiment}
            ...
            results in Table~\ref{tab.fun_bohachevsky5} and
            Table~\ref{tab.fun_bohachevsky10} (for five and ten dimensions,
            respectively). Due to the observation and analysis of these
            results, we identify our proposed strategy obtained solutions in
            the same order as the traditional Xover Mutation, in a
            significantly reduced number of evaluations.
        ...
        \subsubsection{Griewank Benchmark Function Experiment}
            ...
            corresponding Box and Whisker chart, where we summarized the
            results in Table~\ref{tab.fun_griewank5} and
            Table~\ref{tab.fun_griewank10} (for five and ten dimensions,
            respectively). With this analysis, we confirmed our strategy
            continued to obtain solutions in the same order as expected, in a
            reduced number of evaluations, in less time.
        ...
        \subsubsection{Rastrigin Benchmark Function Experiment}
            ...
            corresponding Box and Whisker chart, where we summarized the
            results in Table~\ref{tab.fun_rastrigin5} and
            Table~\ref{tab.fun_rastrigin10} (for five and ten dimensions,
            respectively).
        ...
        \subsubsection{Sphere Benchmark Function Experiment}
            ...
            Table~\ref{tab.fun_sphere5} and Table~\ref{tab.fun_sphere10} (for
            five and ten dimensions, respectively).
